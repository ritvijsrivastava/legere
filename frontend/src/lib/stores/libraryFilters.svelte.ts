 ...
 *  top of whatever view (Library/Favorites/Highlights) and search term a
 *  page has already narrowed down to. There's no server-side query for
 *  this — the whole library is already in memory via `articlesStore`. */
