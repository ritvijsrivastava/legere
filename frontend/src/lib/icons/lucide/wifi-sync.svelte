...
<svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round">
	...
	<path d="M11.965 14.105h4"></path>
	<path d="M17.965 18.105h4L20.43 19.71a5 5 0 0 1-8-1.5"></path>
	<path d="M2 8.82a15 15 0 0 1 20 0"></path>
	<path d="M21.965 22.105v-4"></path>
	<path d="M5 12.86a10 10 0 0 1 3-2.032"></path>
	<path d="M8.5 16.429h.01"></path>
</svg>
